...
/**
 ****************************************************************************************
 * @brief add channels in order to have sufficient number of channels in channel map
 *
 * @param[in] host_ch_map       Pointer to channel map to add the channels
 * @param[in] nb_chnl           Number of channels to add in channel map
 ****************************************************************************************
 */
void llm_add_bad_chnl(struct le_chnl_map *host_ch_map, uint8_t nb_chnl);
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE bool llm_util_check_adv_report_list(struct bd_addr *adv_bd_addr, uint8_t adv_type)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE void llm_util_set_param_scan_dft(void)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint8_t llm_util_rxlen_getf(struct co_buf_rx_desc *rxdesc)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint16_t llm_util_rxtype_getf(struct co_buf_rx_desc *rxdesc)
{
    uint16_t localVal =  rxdesc->rxheader;
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint8_t llm_util_rxtxadd_getf(struct co_buf_rx_desc *rxdesc)
{
    uint16_t localVal =  rxdesc->rxheader;
...
*****************************************************************************************
*/
__STATIC_FORCEINLINE void llm_util_aa_gen(uint8_t *acc_addr)
{
 ...
 * @param[in] payload              pointer to the start of the payload buffer.
 ****************************************************************************************
 */
__STATIC_FORCEINLINE void llm_util_gen_pattern(uint8_t pattern_type, uint8_t payload_len , uint8_t *payload)
{
    uint8_t pattern = 0;
...
__STATIC_FORCEINLINE void llm_util_set_param_adv_dft(void)
{
    // TX Descriptor
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE void llm_util_chk_tst_mode(void)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint8_t llm_util_chk_advdirect_type(void)
{
