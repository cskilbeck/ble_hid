...
void smpc_xor(uint8_t *result, const uint8_t *operand_1, const uint8_t *operand_2);
#else
 ...
 ****************************************************************************************
 */
void smpc_generate_f5(uint8_t conidx);
 ...
 *
 * @param[in] conidx   Connection Index
 * @param[in] aes_res  FIXME
 ****************************************************************************************
 */
void smpc_generate_f5_T(uint8_t conidx, uint8_t *aes_res);
 ...
 ****************************************************************************************
 */
void smpc_generate_f5_P2(uint8_t conidx, uint8_t *aes_res);
 ...
 ****************************************************************************************
 */
void smpc_generate_subkey_P2(uint8_t conidx, uint8_t *aes_res);
 ...
 * @param[in] conidx   Connection Index
 * @param[in] aes_res  FIXME
 * @param[in] local    FIXME
 ****************************************************************************************
 */
void smpc_generate_f4(uint8_t conidx, uint8_t *aes_res, int local);
 ...
 ****************************************************************************************
 */
void smpc_generate_f6(uint8_t conidx, uint8_t *aes_res, bool local);
 ...
 ****************************************************************************************
 */
void smpc_generate_g2(uint8_t conidx, uint8_t *aes_res);
 ...
 * @param[in] conidx        Connection Index
 * @param[in] role          Current role of the device
 * @param[out] reason       The error code that should be emitted upon failure
 ****************************************************************************************
 */
bool smpc_is_sec_mode_reached(uint8_t conidx, uint8_t role, uint8_t *reason);
#else
/**
 ****************************************************************************************
 * @brief Check if the security mode requested by the application or the peer device can
 ...
 */
#ifdef __DA14531_01__
void smpc_pdu_send(uint8_t conidx, uint8_t cmd_code, const void *value);
#else
