 ...
 * @addtogroup KERNEL
 * @{
 * @addtogroup KE_MSG Kernel Message
 * @brief Module for scheduling kernel messages
 * @{
 *
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE struct ke_msg * ke_param2msg(void const *param_ptr)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE void * ke_msg2param(struct ke_msg const *msg)
{
 ...
 *
 * @param[in] param   Pointer to the message to be freed (not the parameter member!)
 ****************************************************************************************
 */
