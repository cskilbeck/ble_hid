...
/**
 ****************************************************************************************
 * @brief Send dummy message to save power if legacy pairing is used in DA14531-01.
...
#elif (!ENABLE_SMP_SECURE) && defined (__DA14531_01__) // save power when legacy pairing is used
 ...
 */
#if (ENABLE_SMP_SECURE) || defined (__DA14531_01__)
