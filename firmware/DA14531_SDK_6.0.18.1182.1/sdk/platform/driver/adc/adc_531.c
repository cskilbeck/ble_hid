 ...
 ****************************************************************************************
 */
__USED static uint16_t adc_correction_apply(uint16_t input)
{
 ...
 ****************************************************************************************
 */
__USED __STATIC_FORCEINLINE int8_t temp_calc(uint16_t adc_sample)
{
    const int32_t temp_coef = 1450;
    // Tx (Celsius) = 25 + (ADCx - ADC_OTP_CAL_25C) / (1.45 * 64) (+/- 0.5, to improve accuracy)
