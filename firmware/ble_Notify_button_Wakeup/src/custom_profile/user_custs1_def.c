...
const struct attm_desc_128 custs1_att_db[CUSTS1_IDX_NB] = {
    ...
    [SVC1_IDX_SVC] = { (uint8_t *)&att_decl_svc, ATT_UUID_128_LEN, PERM(WR, ENABLE), sizeof(custs1_svc1),
    ...
    [SVC1_IDX_CONTROL_POINT_VAL] = { SVC1_CTRL_POINT_UUID_128, ATT_UUID_128_LEN,
    ...
    [SVC1_IDX_CONTROL_POINT_NTF_CFG] = { (uint8_t *)&att_desc_cfg, ATT_UUID_16_LEN,
    ...
    [SVC1_IDX_CONTROL_POINT_USER_DESC] = { (uint8_t *)&att_desc_user_desc, ATT_UUID_16_LEN, PERM(RD, ENABLE),
                                           ...
                                           sizeof(DEF_SVC1_CONTROL_POINT_USER_DESC) - 1,
                                           DEF_SVC1_CONTROL_POINT_USER_DESC },
};
